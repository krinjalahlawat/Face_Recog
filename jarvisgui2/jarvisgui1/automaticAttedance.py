...
trainimagelabel_path = ("C:\\Users\\SSD\\Desktop\\attendancemanagement\\TrainingImageLabel\\Trainner.yml")
trainimage_path = "C:\\Users\\SSD\\Desktop\\attendancemanagement\\TrainingImage"
studentdetail_path = ("C:\\Users\\SSD\\Desktop\\attendancemanagement\\StudentDetails\\studentdetails.csv")
...
def subjectChoose(text_to_speech):
    def FillAttendance():
        ...
        if sub == "":
            ...
            try:
                ...
                print(attendance)
                print(fileName,"yeah file name hai")
                attendance.to_csv(fileName, index_label=False)
                ...
                root.mainloop()
                print(attendance)
                print("last try mein hun automatic")
            except Exception:
                traceback.print_exc()
    ...
    def Attf():
        ...
        if sub == "":
            ...
            os.startfile(
                f"C:\\Users\\SSD\\Desktop\\attendancemanagement\\Attendance\\{sub}"
            )
            print("started file")
